...
const page = () => {
  ...
  return (
    <div>
      <div
        className={`bg-[url('/assets/contact-bg.jpg')] bg-center bg-cover transition-transform duration-1000 ${
          loaded ? "scale-95" : "scale-110"
        }`}
      >
        <h1 className="container py-28 text-6xl font-semibold text-black tracking-widest text-center lg:py-36">
          Get in Touch
        </h1>
      </div>
